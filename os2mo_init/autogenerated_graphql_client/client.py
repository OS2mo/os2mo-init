...
class GraphQLClient(AsyncBaseClient):
    ...
    async def create_class_mutation(
        ...
        query = gql(
            """
            mutation CreateClassMutation($facet_uuid: UUID!, $user_key: String!, $name: String!, $description: String, $scope: String, $it_system_uuid: UUID) {
              class_create(
                input: {facet_uuid: $facet_uuid, user_key: $user_key, name: $name, description: $description, scope: $scope, it_system_uuid: $it_system_uuid, validity: {from: null}}
              ) {
                uuid
              }
            }
    ...
    async def update_class_mutation(
        ...
        query = gql(
            """
            mutation UpdateClassMutation($facet_uuid: UUID!, $uuid: UUID!, $user_key: String!, $name: String!, $description: String, $scope: String, $it_system_uuid: UUID) {
              class_update(
                input: {uuid: $uuid, facet_uuid: $facet_uuid, user_key: $user_key, name: $name, description: $description, scope: $scope, it_system_uuid: $it_system_uuid, validity: {from: null}}
              ) {
                uuid
              }
            }
